...
nexttrend:
            ...
            Else
                ...
                Set usetable = ActiveSheet.ListObjects(thistable)
...
AssembleData = ActiveSheet.Name
AssembleHeaderRow = Application.Match("Color", ActiveSheet.Range("A:A"), False)
...
With ActiveSheet.Range("B" & chartheadrow & ":G" & chartheadrow)
    .MergeCells = True
    .Interior.color = 6968388
    .HorizontalAlignment = xlLeft
    .Font.color = RGB(255, 255, 255)
    ...
    .Value = trendname
End With
With ActiveSheet.Range("H" & chartheadrow & ":J" & chartheadrow)
    .MergeCells = True
    .Interior.color = 6968388
    .HorizontalAlignment = xlLeft
    .Font.color = RGB(255, 255, 255)
    ...
    .Value = "Comments"
End With
With ActiveSheet.Range("B" & chartheadrow + 1 & ":G" & chartheadrow + 12)
    .MergeCells = True
    '.Border = True
End With
With ActiveSheet.Range("H" & chartheadrow + 1 & ":J" & chartheadrow + 12)
    .Merge (True)
    .HorizontalAlignment = xlLeft
    .Font.Name = "Calibri"
    .Font.Size = 11
